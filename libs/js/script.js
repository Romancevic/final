            ...
            if (data) {
                if (data.length > 0) {
                    ...
                    API.addInfos([
                        {
                            title: 'Confirmed',
                            text: main['Confirmed'] || 'No-Data'
                        },
                        {
                            title: 'Recovered',
                            text: main['Recovered'] || 'No-Data',
                        },
                        {
                            title: 'Deaths',
                            text: main['Deaths'] || 'No-Data',
                        },
                        {
                            title: 'Last Update',
                            text: main['Date'] || 'No-Data',
                            size: 'wide'
                        }
                    ])
...
function getGeoJson() {
    $.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown){
            alert(`No boundary data for this country`);
